...
const Contact = () => {
  return (
    ...
    >
      <div
        className="max-w-screen-2xl flex flex-col xl:flex-row 2xl:justify-between 
      ...
      >
        <div className="flex-1 flex flex-col gap-4">
          <h2 className="text-center xl:text-start text-4xl sm:text-5xl lg:text-[64px] font-bold text-textPrimary">
            Got a question for <span className="text-secondary"> me?</span>
          </h2>
      ...
      <div className="absoloute bottom-0 left-0 w-full h-[1px] bg-divider" />
    </div>
  );
};
