    ...
    >
      <div className="max-w-screen-2xl flex flex-row gap-10 w-full py-16 px-12">
        ...
        <motion.div
          ...
          whileInView={"visible"}
          viewport={{ once: false }}
          className="flex-1 flex flex-wrap justify-center items-center gap-4 md:hidden, sm:hidden"
        >
          <img
            src={jsLogo}
            alt="JavaScript Logo"
            className="w-40 h-40 sm:hidden md:hidden lg:contents xl:contents"
          />
          <img
            src={mernLogo}
            alt="MERN Stack Logo"
            className="w-80 h-40 sm:hidden md:hidden lg:contents xl:contents"
          />
          <img
            src={firebaseLogo}
            alt="Firebase Logo"
            className="w-83 h-40 sm:hidden md:hidden lg:contents xl:contents"
          />
        </motion.div>
      </div>
    </div>
