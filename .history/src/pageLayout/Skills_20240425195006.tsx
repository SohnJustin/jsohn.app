      ...
      <div className="max-w-screen-2xl flex flex-row gap-10 w-full py-16 px-12">
        ...
        >
          <img
            src={jsLogo}
            alt="JavaScript Logo"
            className="w-40 h-40 hidden lg:contents xl:contents"
          />
          <img
            src={mernLogo}
            alt="MERN Stack Logo"
            className="w-80 h-40 hidden lg:contents xl:contents"
          />
          <img
            src={firebaseLogo}
            alt="Firebase Logo"
            className="w-83 h-40 hidden lg:contents xl:contents"
          />
        </motion.div>
      </div>
    </div>
